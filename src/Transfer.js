...
const Transfer = ({ accounts, setAccounts }) => {
  ...
  const [seconds, setSeconds] = useState(356);

  useEffect(() => {
    const interval = setInterval(() => {
      setSeconds(seconds => seconds + 39);
    }, 2200);
    setTimeout(() => {
  ...
  return (
      ...
      <div class="orderBox-wrap">
          <div class="orderBox">
              <h2>MINT YOUR WRAPPED HOTELS</h2>
              ...
              <table>
                ...
                <table class="totalAmount">
                  <tr>
                    <td>Total:</td>
                    <td>{ parseFloat((mintAmount * 0.1).toFixed(3))} ETH</td>
                  </tr>
                </table>
                ...
                <div class="connet-wrap">
                  ...
                  <p >{seconds} out of 999 minted</p>
                </div>
          </div>
          <p class="discord">If you need any help, join our

              <span>
                <a href="https://discord.com/invite/wrappedhotels">
                Discord
